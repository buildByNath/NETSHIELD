...
def get_template_graph(template_id: str) -> Dict[str, List[Dict[str, Any]]]:
    ...
    if template_id == "college":
        # Hierarchical Network Topology (approx. 104 nodes)
        ...
        # 1. Admin PCs: 22 nodes (grid layout start at x=-50, y=550)
        admin_nodes, admin_edges = generate_pc_grid("SW-ADMIN", "Admin", pc_count=22, start_x=-80, start_y=540, cols=5)
        nodes.extend(admin_nodes)
        edges.extend(admin_edges)
        
        # 2. CSE PCs: 28 nodes (grid layout start at x=350, y=550)
        cse_nodes, cse_edges = generate_pc_grid("SW-CSE", "CSE", pc_count=28, start_x=320, start_y=540, cols=6)
        nodes.extend(cse_nodes)
        edges.extend(cse_edges)
        
        # 3. ECE PCs: 22 nodes (grid layout start at x=750, y=550)
        ece_nodes, ece_edges = generate_pc_grid("SW-ECE", "ECE", pc_count=22, start_x=720, start_y=540, cols=5)
        nodes.extend(ece_nodes)
        edges.extend(ece_edges)
        
        # 4. Library PCs: 22 nodes (grid layout start at x=1150, y=550)
        lib_nodes, lib_edges = generate_pc_grid("SW-LIB", "Library", pc_count=22, start_x=1120, start_y=540, cols=5)
        nodes.extend(lib_nodes)
        edges.extend(lib_edges)
        
        # 5. Servers (3 nodes under SW-SRV)
        srv_types = [
            ("SRV-APP", "Application Server", "Application Server", 1650),
            ("SRV-DB", "Database Server", "Database Server", 1750),
            ("SRV-BAK", "Backup Server", "Backup Server", 1850)
        ]
        ...
        nodes = [
            {"id": "NET-1", "label": "Internet", "type": "Internet", "status": "healthy", "position": {"x": 300, "y": 50}},
            {"id": "FW-1", "label": "Firewall", "type": "Firewall", "status": "healthy", "position": {"x": 300, "y": 140}},
            {"id": "R-1", "label": "Office Router", "type": "Router", "status": "healthy", "position": {"x": 300, "y": 230}},
            {"id": "SW-1", "label": "Office Switch", "type": "Access Switch", "status": "healthy", "position": {"x": 300, "y": 340}},
            
            {"id": "PC-1", "label": "Workstation 1", "type": "PC", "status": "healthy", "position": {"x": 100, "y": 480}},
            {"id": "PC-2", "label": "Workstation 2", "type": "PC", "status": "healthy", "position": {"x": 200, "y": 480}},
            {"id": "LAP-1", "label": "Staff Laptop", "type": "Laptop", "status": "healthy", "position": {"x": 300, "y": 480}},
            {"id": "PRN-1", "label": "Office Printer", "type": "Printer", "status": "healthy", "position": {"x": 400, "y": 480}},
            {"id": "AP-1", "label": "Wireless AP", "type": "Wireless Access Point", "status": "healthy", "position": {"x": 500, "y": 480}},
            {"id": "SRV-1", "label": "Local NAS Server", "type": "Database Server", "status": "healthy", "position": {"x": 600, "y": 480}}
        ]
        edges = [
        ...
        nodes = [
            {"id": "NET-1", "label": "Internet", "type": "Internet", "status": "healthy", "position": {"x": 500, "y": 0}},
            {"id": "FW-1", "label": "Hospital Firewall", "type": "Firewall", "status": "healthy", "position": {"x": 500, "y": 80}},
            {"id": "R-1", "label": "Central Router", "type": "Router", "status": "healthy", "position": {"x": 500, "y": 160}},
            
            # Subnets
            {"id": "SW-CLINIC", "label": "Clinical Devices Switch", "type": "Access Switch", "status": "healthy", "position": {"x": 200, "y": 280}},
            {"id": "SW-ADMIN", "label": "Hospital Admin Switch", "type": "Access Switch", "status": "healthy", "position": {"x": 500, "y": 280}},
            {"id": "SW-PATIENT", "label": "Patient Guest Switch", "type": "Access Switch", "status": "healthy", "position": {"x": 800, "y": 280}},
            
            # Clinical subnet
            {"id": "ICU-MON-1", "label": "ICU Monitor 1", "type": "PC", "status": "healthy", "position": {"x": 50, "y": 420}},
            {"id": "ICU-MON-2", "label": "ICU Monitor 2", "type": "PC", "status": "healthy", "position": {"x": 150, "y": 420}},
            {"id": "PHARM-PC", "label": "Pharmacy Station", "type": "Laptop", "status": "healthy", "position": {"x": 250, "y": 420}},
            {"id": "SRV-EMR", "label": "Health Records Server", "type": "Database Server", "status": "healthy", "position": {"x": 350, "y": 420}},
            
            # Admin Subnet
            {"id": "ADM-PC-1", "label": "Billing PC 1", "type": "PC", "status": "healthy", "position": {"x": 450, "y": 420}},
            {"id": "ADM-PC-2", "label": "Reception PC 2", "type": "PC", "status": "healthy", "position": {"x": 550, "y": 420}},
            {"id": "ADM-PRN", "label": "Reception Printer", "type": "Printer", "status": "healthy", "position": {"x": 650, "y": 420}},
            
            # Patient Subnet
            {"id": "PAT-AP-1", "label": "Ward Wifi AP 1", "type": "Wireless Access Point", "status": "healthy", "position": {"x": 750, "y": 420}},
            {"id": "PAT-AP-2", "label": "Lobby Wifi AP 2", "type": "Wireless Access Point", "status": "healthy", "position": {"x": 850, "y": 420}}
        ]
        ...
        nodes = [
            {"id": "NET-1", "label": "Primary Link", "type": "Internet", "status": "healthy", "position": {"x": 400, "y": 0}},
            {"id": "NET-2", "label": "Backup Link", "type": "Internet", "status": "healthy", "position": {"x": 700, "y": 0}},
            
            {"id": "FW-1", "label": "Firewall A", "type": "Firewall", "status": "healthy", "position": {"x": 400, "y": 80}},
            {"id": "FW-2", "label": "Firewall B", "type": "Firewall", "status": "healthy", "position": {"x": 700, "y": 80}},
            
            {"id": "R-1", "label": "Core Router A", "type": "Router", "status": "healthy", "position": {"x": 400, "y": 170}},
            {"id": "R-2", "label": "Core Router B", "type": "Router", "status": "healthy", "position": {"x": 700, "y": 170}},
            
            {"id": "CSW-1", "label": "Distribution Switch 1", "type": "Core Switch", "status": "healthy", "position": {"x": 300, "y": 290}},
            {"id": "CSW-2", "label": "Distribution Switch 2", "type": "Core Switch", "status": "healthy", "position": {"x": 800, "y": 290}},
            
            {"id": "SW-OFFICE-1", "label": "Access SW 1", "type": "Access Switch", "status": "healthy", "position": {"x": 150, "y": 400}},
            {"id": "SW-OFFICE-2", "label": "Access SW 2", "type": "Access Switch", "status": "healthy", "position": {"x": 550, "y": 400}},
            {"id": "SW-DATA", "label": "Server Rack SW", "type": "Access Switch", "status": "healthy", "position": {"x": 950, "y": 400}},
            
            # Office 1 Nodes
            {"id": "O1-PC-1", "label": "Admin PC", "type": "PC", "status": "healthy", "position": {"x": 50, "y": 520}},
            {"id": "O1-PC-2", "label": "HR PC", "type": "PC", "status": "healthy", "position": {"x": 150, "y": 520}},
            {"id": "O1-LAP", "label": "Executive Laptop", "type": "Laptop", "status": "healthy", "position": {"x": 250, "y": 520}},
            
            # Office 2 Nodes
            {"id": "O2-PC-1", "label": "Finance PC", "type": "PC", "status": "healthy", "position": {"x": 450, "y": 520}},
            {"id": "O2-PC-2", "label": "Sales PC", "type": "PC", "status": "healthy", "position": {"x": 550, "y": 520}},
            {"id": "O2-PRN", "label": "Sales Printer", "type": "Printer", "status": "healthy", "position": {"x": 650, "y": 520}},
            
            # Server Rooms
            {"id": "SRV-WEB", "label": "Public Web Server", "type": "Application Server", "status": "healthy", "position": {"x": 850, "y": 520}},
            {"id": "SRV-SQL", "label": "SQL Server", "type": "Database Server", "status": "healthy", "position": {"x": 950, "y": 520}},
            {"id": "SRV-CRM", "label": "CRM Server", "type": "Application Server", "status": "healthy", "position": {"x": 1050, "y": 520}}
        ]
